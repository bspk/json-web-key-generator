...
To generate a key, run `java -jar json-web-key-generator-0.4-SNAPSHOT-jar-with-dependencies.jar -s 2048 -t <keytype>`. Several other arguments are defined which may be required depending on your key type:
